defmodule PageScraperWeb.PageControllerTest do
  use PageScraperWeb.ConnCase
  ...
  def fixture(:page) do
    {:ok, page} = Scraper.create_page(@create_attrs)
    page
  end
  ...
  describe "index" do
    test "lists all pages", %{conn: conn} do
      ...
      assert html_response(conn, 200) =~ "All Pages"
    end
  end
  ...
  describe "create page" do
    test "redirects to show when data is valid", %{conn: conn} do
      ...
      assert html_response(conn, 200) =~ "Page Details"
    end
